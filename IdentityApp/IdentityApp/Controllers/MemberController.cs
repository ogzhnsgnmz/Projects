...
namespace IdentityApp.Controllers
{
    ...
    public class MemberController : Controller
    {
        ...
        public async Task<IActionResult> PasswordChanges()
        {
            return View();
        }

        [HttpPost]
        public async Task<IActionResult> PasswordChanges(PasswordChangeViewModel request)
        {
        ...
        public async Task<IActionResult> UserEdit(UserEditViewModel request)
        {
            ...
            if(request.Picture != null && request.Picture.Length>0)
            {
                ...
                var newPicturePath = Path.Combine(wwwrootFolder!
                    .First(x=>x.Name == "userpictures").PhysicalPath!, randomFileName);
